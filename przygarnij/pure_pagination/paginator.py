...
class Page(object):
    ...
    def pages(self):
        ...
        self.pages_cache = result
        return result

    @add_page_querystring
    def left_margin_range(self):
        return range(1, MARGIN_PAGES_DISPLAYED+1)

    @add_page_querystring
    def right_margin_range(self):
        return range(self.paginator.num_pages-MARGIN_PAGES_DISPLAYED+1, self.paginator.num_pages+1)
