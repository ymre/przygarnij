...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Advert'
        db.create_table('wymiana_advert', (
            ...
            ('what_for', self.gf('django.db.models.fields.TextField')(blank=True)),
        ...
        db.send_create_signal('wymiana', ['Advert'])


    def backwards(self, orm):
        
        # Deleting model 'Advert'
        db.delete_table('wymiana_advert')
